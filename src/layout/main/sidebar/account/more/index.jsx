    ...
    return(
        <div >
            {accounts.map(account => (
                <button type="button" disabled={currentAccount.id === account.id} onClick={() => {
                    setCurrentAccount(account)
                }}
                     className={classNames("py-3 px-4 flex items-center text-left w-full transition-colors hover:bg-[#eff3f41a]",{
            ...
            <button className="py-3 px-4 text-left transtion-colors hover:bg-[#eff3f41a] w-full text-[#e7e9ea] text-[15px] font-bold ">

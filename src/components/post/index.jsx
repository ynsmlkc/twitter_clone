        ...
        <div className="px-4 py-3 gap-3 border-b border-[#2f3336] flex" >
            ...
            <div className="flex-1 ">
                <header className="leading-5 flex items-center gap-2 mb-0.5  ">
                      ...
                      <div className="text-[#717b76] flex items-center gap-1.5">
                        <div>@{post.account.username}</div>
                        <div className="w-0.5 h-0.5 rounded-full bg-[#717b76]"/>
                        <div>17s</div>
                      </div>
                </header>
                <div>
                    ...
                    <div className="flex -ml-1.5 mt-1.5">
                        <div className="flex-1 group flex items-center gap-px">
                            <div className="w-[2.172rem] h-[2.172rem] transition-colors flex items-center justify-center text-[#717b76] group-hover:bg-[#1d9bf01a] rounded-full group-hover:text-[#1d9bf0] ">
                            ...
                            <span className="text-[0.813rem] transition-colors text-[#717b76] group-hover:text-[#1d9bf0] ">{numberFormat(post.stats.comments)} </span>
                        </div>
                        <div className="flex-1 group flex items-center gap-px  ">
                           <div className="w-[2.172rem] h-[2.172rem] transition-colors flex items-center justify-center text-[#717b76] group-hover:bg-[#00ba7c1a] rounded-full group-hover:text-[#00ba7c] ">
                              <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                            ...
                            <span className="text-[0.813rem] flex items-center transition-colors text-[#717b76] group-hover:text-[#00ba7c] ">{numberFormat(post.stats.repost)} </span>
                        </div>
                        <div className="flex-1 group flex items-center ">
                           <div className="w-[2.172rem] h-[2.172rem] transition-colors flex items-center justify-center text-[#717b76] group-hover:bg-[#f918801a] rounded-full group-hover:text-[#f91880] ">
                             <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                            ...
                            <span className="text-[0.813rem] flex items-center transition-colors text-[#717b76] group-hover:text-[#f91880] ">{numberFormat(post.stats.like)} </span>
                        </div>
                        <div className="flex-1 group flex items-center">
                           <div className="w-[2.172rem] h-[2.172rem] transition-colors flex items-center justify-center text-[#717b76] group-hover:bg-[#1d9bf01a] rounded-full group-hover:text-[#1d9bf0] ">
                               <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                           ...
                           <span className="text-[0.813rem] flex items-center transition-colors text-[#717b76] group-hover:text-[#1d9bf0] ">{numberFormat(post.stats.view)} </span>
                        </div>
